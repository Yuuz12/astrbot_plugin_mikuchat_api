...
@register("MikuchatApi", "Yuuz12", "可调用MikuChat API", "1.2.0", "https://github.com/Yuuz12/astrbot_plugin_mikuchat_api")
...
class BiPlugin(Star):
    ...
    async def bi_history(self, event: AstrMessageEvent, coin: str, limit: int = 30):
